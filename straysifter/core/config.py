...
class Config:
    ...
    # парсер сам разбирается, что в тексте: vless/vmess/trojan/ss/socks/
    # http/mtproto, base64-подписка, Clash YAML, CSV, plain host:port.
    #
    # Дефолт содержит пример-заглушку. Замени его на свои URL:
    #   - публичные подписки (raw.githubusercontent.com)
    #   - gitverse (gitverse.ru/api/repos/.../raw/branch/.../file)
    #   - собственные файлы (https://твой-сервер/sub.txt)
